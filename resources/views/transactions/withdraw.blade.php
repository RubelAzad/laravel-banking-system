    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            <div class="card">
                ...
                @endif
                <button type="button" class="btn btn-primary mb-2" data-toggle="modal" data-target="#exampleModal" data-whatever="@mdo">Withdraw</button>
                ...
                <table id="transactions-table" class="table table-striped table-bordered" style="width:100%">
                    ...
                    <tbody>
                    @foreach($withdrawTransactions as $withdraw)
                        <tr>
                            <td>{{ $withdraw->id }}</td>
